#!/usr/bin/env python3
"""
Quick Advanced ML Opportunities Generator
This script generates opportunities using the advanced ensemble system for testing.
"""
...
def generate_quick_opportunities():
    """Generate opportunities using the advanced system for testing."""
    logger.info("🚀 Generating Quick Advanced ML Opportunities...")
    ...
    # Use first 20 symbols for quick test
    ...
    logger.info("✅ Quick Advanced ML Opportunities Generation completed!")
