#!/usr/bin/env python3
"""
Script de test pour le monitoring de la recherche d'opportunités
"""
...
def test_opportunity_search_monitoring():
    """Test du monitoring de la recherche d'opportunités"""
    
    print("🔍 Test du monitoring de la recherche d'opportunités")
    print("=" * 80)
            ...
            if response.status_code == 200:
                ...
                if state == 'SUCCESS':
                    ...
                    if results:
                        ...
                        for i, opp in enumerate(results[:5]):  # Afficher les 5 premières
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if opportunities:
                ...
                for i, opp in enumerate(opportunities[:3]):  # Afficher les 3 premières
