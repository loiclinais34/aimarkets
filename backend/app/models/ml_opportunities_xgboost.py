...
class MLOpportunityXGBoost(Base):
    __tablename__ = 'ml_opportunities_xgboost'
    ...
    __table_args__ = (
        Index('idx_ml_opportunities_xgboost_symbol_date', 'symbol', 'date'),
        Index('idx_ml_opportunities_xgboost_horizon', 'horizon_days'),
        Index('idx_ml_opportunities_xgboost_recommendation', 'recommendation'),
        Index('idx_ml_opportunities_xgboost_confidence', 'confidence_level'),
    )
